...
StigForge-exported Ansible role **`ubuntu24_stig`** · release **`0.2.4-private-review`**.
...
```bash
ansible-galaxy role install stigready.ubuntu24_stig,0.2.4-private-review
```
...
|---|---:|---:|---|---|---|
| `stig` | **98.08%** ✓ | 90.0% | PASS ✓ | rc 0 | 20260729T100300Z |
