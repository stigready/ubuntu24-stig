...
StigForge-exported Ansible role **`ubuntu24_stig`** · release **`0.3.0`**.
...
```bash
ansible-galaxy role install stigready.ubuntu24_stig,0.3.0
```
...
|---|---:|---:|---|---|---|
| `stig` | **96.55%** ✓ | 90.0% | PASS ✓ | rc 0 | 20260912T131233Z |
